                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form>
                                ...
                                <div class="row mb-3">
                                    <label for="inputDate" class="col-sm-2 col-form-label start"> Start Date</label>
                                    <div class="col-sm-10">
                                        <input type="date" class="form-control">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputTime" class="col-sm-2 col-form-label start"> Start Time</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="row mb-3">
                                    <label for="inputDate" class="col-sm-2 col-form-label end"> End Date </label>
                                    <div class="col-sm-10">
                                        <input type="date" class="form-control">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputTime" class="col-sm-2 col-form-label end"> End Time</label>
                                    <div class="col-sm-10">
                                        <input type="time" class="form-control">
                                    </div>
                                </div>
